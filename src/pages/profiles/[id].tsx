...
const ProfilePage: NextPage<InferGetStaticPropsType<typeof getStaticProps>> = ({ 
  ...
  return(
    <>
     <Head>
        <title>{`SU-Media - ${profile.name}`}</title>
    </Head>
     <header className="sticky top-0 z-10 items-center border-b bg-white
     px-4 py-2">
        ...
        <div className="ml-2 flex-grow">
            ...
            <div className="text-gray-500">
                ...
                {getPlural(profile.messagesCount, "Post", "Posts")}
